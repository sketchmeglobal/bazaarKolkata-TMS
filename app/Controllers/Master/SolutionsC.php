...
use App\Models\Master\SolutionsM;

class SolutionsC extends BaseController
{
   public function index(){ 
      ...
      if($session->logged_in == '') {
          ...
          $head_officeM = new SolutionsM();           
          $data['rows'] = $head_officeM->getAllSolution();            
          $data['tt_rows'] = $head_officeM->getAllTicketTopic();           
         return view('master/solutions', $data);
      }
   }
