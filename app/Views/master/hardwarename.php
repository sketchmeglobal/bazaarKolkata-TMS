...
<body>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle"> Add/Edit Hardware </h5>
                                ...
                                <form class="needs-validation" novalidate name="s_myFormName" id="s_myFormName">
                                    <div class="form-row">
                                        <div class="col-md-4 mb-1">
                                            ...
                                            <input type="text" class="form-control" name="hardwareName" id="hardwareName" value="" > 
                                        </div>  
                                        <div class="col-md-4 mb-1">
                                            <label for="hardwareCode">Hardware Code</label>
                                            <input type="text" class="form-control" name="hardwareCode" id="hardwareCode" value="" > 
                                        </div>                              
    ...
    <script>
        ...
        function validateForm(){
            $hardwareName = $('#hardwareName').val().replace(/^\s+|\s+$/gm,'');
            $hardwareCode = $('#hardwareCode').val().replace(/^\s+|\s+$/gm,'');
            ...
            if($hardwareName == ''){
                ...
                $('#hardwareName').removeClass('is-valid');
                $('#hardwareName').addClass('is-invalid');
            }else{
                $('#hardwareName').removeClass('is-invalid');
                $('#hardwareName').addClass('is-valid');
            }

            if($hardwareCode == ''){
                $status = false;
                $formValidMsg += ', Code';
                $('#hardwareCode').removeClass('is-valid');
                $('#hardwareCode').addClass('is-invalid');
            }else{
                $('#hardwareCode').removeClass('is-invalid');
                $('#hardwareCode').addClass('is-valid');
            } 
        ...
        $('#myTable').on('click', '.edit_class', function(){ 
            ...
            $('#hardwareName').val('Monitor');
            $('#hardwareCode').val('MTR');
            $('#myModal').modal('show');
