    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-evenly">
                                        <a href="javascript: void(0);" class="edit_class" data-table_id="<?=$row['de_id']?>"><i class="fa fa-edit"></i></a>
                                        <a class="remove" href="javascript: void(0);" data-table_id="<?=$row['de_id']?>"><i class="fas fa-times"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                                <?php endif ?>
                            ...
                            <form class="needs-validation" id="s_myFormName" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-11 col-12 mb-2">
                                        ...
                                        <span class="error" id="dept_nameError">
                                    ...
                                    <div class="col-md-11 col-12 mb-2">
                                        ...
                                        <span class="error" id="dept_codeError"><?= (isset($validation['address']) ? $validation['address'] : ''); ?></span>
                                    </div>
            ...
            function validateForm(){
                $dept_name = $('#dept_name').val().replace(/^\s+|\s+$/gm,'');
                $dept_code = $('#dept_code').val().replace(/^\s+|\s+$/gm,'');
            ...
            $('#s_submitForm').click(function(){
                ...
                setTimeout(function(){
                    ...
                    if($formVallidStatus == true){
                        ...
                        $.ajax({  
                            url: '<?php echo base_url('admin/formValidationDE'); ?>',
                            type: 'post',
                            dataType:'json',
                            data:{query: $query},
                                ...
                                if(data.status == true ){
                                    ...
                                    if(parseInt(data.ho_id) > 0){
                                        ...
                                        var row = $('<tr>')
                                            ...
                                            .append('<td>'+$dept_name+'</td>')
                                            .append('<td>'+$dept_code+'</td>')
            ...
            $(".remove").click(function() {
                if(confirm("Are You Sure? This Process Can\'t be Undone.")){
                    ...
                    $.ajax({  
                        url: '<?php echo base_url('admin/removeTableDataDE'); ?>',
                        type: 'post',
                        dataType:'json',
            ...
            $(".edit_class").click(function() {
                ...
                $.ajax({  
                    url: '<?php echo base_url('admin/getTableDataDE'); ?>',
                    type: 'post',
                    dataType:'json',
                    data:{table_id: $table_id},
                    success:function(data){
                        ...
                        if(data.status == true ){
                            ...
                            $('#table_id').val(data.result.de_id);
                            $('#myModal').modal('show');
                        }
                    }  
                });//end ajak
