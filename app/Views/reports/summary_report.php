											...
											<tr>
												<td valign="top" class="bodyContent">
													<div mc:edit="std_content00">
														A Ticket <strong>(TIK-SMG-2)</strong> was generated From the Outlet <strong>'Outlet Dunlop'.</strong> The ticket wasgenerated by <strong>Suman Jana</strong>
													</div>
												</td>
											</tr>
											<tr>
												<td valign="top" class="bodyContent">
													<div mc:edit="std_content00">
														This task <strong>first time</strong> attened by Field engineer <strong>Amar Bhowmick.</strong> 
													</div>
												</td>
											</tr>
											<tr>
												<td valign="top" class="bodyContent">
													<div mc:edit="std_content00">
														Then a Service Request <strong>Generated</strong> by <strong>Subir Paul.</strong> 
													</div>
												</td>
											</tr>
											<tr>
												<td valign="top" class="bodyContent">
													<div mc:edit="std_content00">
														The Service Request <strong>Approved</strong> by <strong>Dipali Paul.</strong> 
													</div>
												</td>
											</tr>
											<tr>
												<td valign="top" style="padding-top:0; padding-bottom:0;">
													...
													<table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
														...
														<tr mc:repeatable>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content00">1</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content01">Keyboard(KB10)</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">KB001</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">Old Hardware received</td>
														</tr>
														<tr mc:repeatable>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content00">2</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content01">Mouse(MO10)</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">MO001</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">Old Hardware received</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td valign="top" style="padding-top:5; padding-bottom:0;">
													...
													<table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
														...
														<tr mc:repeatable>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content00">1</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content01">Keyboard(KB20)</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">KB002</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">New Hardware Issued</td>
														</tr>
														<tr mc:repeatable>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content00">2</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content01">Mouse(MO20)</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">MO002</td>
															<td valign="top" class="dataTableContent" mc:edit="data_table_content02">New Hardware Issued</td>
														</tr>
													</table>
												</td>
										...
										<table border="0" cellpadding="10" cellspacing="0" width="100%">
											<tr>
												<td valign="top">
													...
													"Baazar Kolkata and Kolkata Baazar are registered trademarks of Baazar Retail Private Limited
(Formerly known as Bees Merchandise Private Limited)"
													</div>
												</td>
											</tr>
											<tr>
