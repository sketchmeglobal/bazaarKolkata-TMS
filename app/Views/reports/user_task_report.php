				...
				<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer">
					...
					<tr>
						<td align="center" valign="top">
							...
							if($rows):
							?>
							<h4 style="padding-left: 10px;">User Task Report</h4>
							<table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
								<tr>
									...
									<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading01"> Ticket No. </th>
									<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading02"> Create By. </th>
									<th scope="col" valign="top" width="30%" class="dataTableHeading" mc:edit="data_table_heading02">Accepted By </th>
								</tr>
								<?php
									$sl = 1;
									foreach($rows as $row):
								...
								<tr mc:repeatable>
									...
									<td valign="top" class="dataTableContent" mc:edit="data_table_content01"><?=$row->ticket_number?> </td>
									<td valign="top" class="dataTableContent" mc:edit="data_table_content02"><?=$row->emp_name?> </td>
									<td valign="top" class="dataTableContent" mc:edit="data_table_content02"><?=$row->accepted_by_name?> </td>
								</tr>
								<?php
									$sl++;
									endforeach;
